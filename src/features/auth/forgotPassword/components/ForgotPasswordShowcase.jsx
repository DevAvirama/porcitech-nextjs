export default function ForgotPasswordShowcase() {
  return (
    <div className="relative h-full flex flex-col justify-center items-center p-12 text-center text-white bg-zinc-950">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(57,169,0,0.05),transparent_60%)] pointer-events-none" />
      <div className="space-y-6 max-w-sm relative z-20">
        <div className="w-16 h-16 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mx-auto text-sena-green shadow-lg">
